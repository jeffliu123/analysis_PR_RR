...
def cal_MAE_RMSE(result,df_estimate):
    ...
    RMSE_sum = 0
    num_count = 0
    for i in range(20,len(result)):#len(result)
...
def main():
    ...
    count = 0
    s = 0
    # path = r"/media/bestlab/Transcend/21th_c/Datasets/Dark/0106_chi/Front/Vernier/0106_chi_dark_1235_vernier_rb.csv"
    path = r"/media/bestlab/Transcend/0330RR/yantinglight.csv"
    path_estimate = r"/home/bestlab/Desktop/final_com_v1/data_comp/Light/yt0330_Front/RR.csv"
